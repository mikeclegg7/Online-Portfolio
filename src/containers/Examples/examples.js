  ...
  render() {
    const Examples = {
      TAD: {
        ...
        summary:
          "In 2016 I started a Wordpress website called Travel and Destinations. This website now has content designed to provide travel inspiration as well as travel tips. The site now gets a large amount of traffic (approx 100,000 users per month). I spend my free time on improving the site, adding new and custom features, as well as adding new content. You can almost think of it partly as my playground.",
