    ...
    render() {
        return (
            <div className={classes.Textblock}>
                ...
                Currently I work in a marketing role, but on the side I am a Web Developer running my personal web site and also building my technical skills such as React (which this site is built in).
                <br/><br/>
                I am now living in London UK, but over the last 6 years I have also lived in Toronto Canada, as well as Vienna Austria. I am now settled in London for the foreseeable future.<br/><br/>
                ...
                To learn about my career since then, see skills I have and the technology I am familiar with then see the various links in the menu above. You can also go to my examples page to learn a little about projects I've worked on.<br/><br/>
